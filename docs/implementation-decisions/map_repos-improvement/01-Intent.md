...
This effort is not intended to make `map_repo.py`:

- understand complete application semantics;
- execute repository code;
- install dependencies;
- replace targeted source reading;
- replace semantic code search;
- clone every repository by default;
- become a provider-specific automation framework;
- push repository contents into model context.

Repository-map output remains structural evidence rather than verified application behavior.
