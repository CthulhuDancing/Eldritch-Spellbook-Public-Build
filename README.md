...
A lean plugin for smoother, lower-overhead co-development across ChatGPT and coding-agent workflows.
...
- [`agent-context-bridge`](plugins/eldritch-spellbook/skills/agent-context-bridge/) recognizes when work should move between normal chat and a coding agent, using project handoffs for broader continuation context and targeted task handoffs for one bounded coding-agent request.
